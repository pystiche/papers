...
The procedures briefly presented above are part of the replication study and are published as a Python package \texttt{pystiche/papers}. The source code\footnote{\url{https://github.com/pmeier/pystiche_papers}} as well as the documentation\footlabel{docs}{\url{https://pystiche-papers.readthedocs.io}} of \texttt{pystiche/papers} are available online. 